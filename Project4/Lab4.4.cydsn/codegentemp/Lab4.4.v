// ======================================================================
// Lab4.4.v generated from TopDesign.cysch
// 05/12/2022 at 20:10
...
// TCPWM_PWM_PDL_v1_0(ClockPrescaler=0, Compare0=1000, Compare1=16384, CountInput=7, CountInputMasked=3, DeadClocks=0, EnableCompareSwap=false, EnablePeriodSwap=false, InterruptSource=0, InvertPwm=false, InvertPwm_n=false, KillInput=7, KillInputMasked=3, KillMode=2, Period0=999, Period1=32768, PwmAlignment=0, PwmMode=4, ReloadInput=7, ReloadInputMasked=3, Resolution=16, RunMode=0, StartInput=7, StartInputMasked=3, SwapInput=7, SwapInputMasked=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_PWM_PDL_v1_0, CY_CONFIG_TITLE=PWM_Green, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_Green, CY_INSTANCE_SHORT_NAME=PWM_Green, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_Green, )
...
// bIncludeDriverToComponent_v1_0(PDL_DRIVER_NAME=ble, PDL_DRIVER_REQ_VERSION=2.0.0, PDL_DRIVER_SUBGROUP=Stack library, PDL_DRIVER_VARIANT=Profile - Host CM4 / Ctrl CM4, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=bIncludeDriverToComponent_v1_0, CY_CONFIG_TITLE=IncludeBleLibs, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BLE:IncludeBleLibs, CY_INSTANCE_SHORT_NAME=IncludeBleLibs, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ble, CY_PDL_DRIVER_REQ_VERSION=2.0.0, CY_PDL_DRIVER_SUBGROUP=Stack library, CY_PDL_DRIVER_VARIANT=Profile - Host CM4 / Ctrl CM4, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=BLE_IncludeBleLibs, )
...
// TCPWM_Counter_PDL_v1_0(CaptureInput=1, CaptureInputMasked=1, ClockPrescaler=0, Compare0=16384, Compare1=16384, CompareOrCapture=2, CountDirection=0, CountInput=7, CountInputMasked=3, EnableCompareSwap=false, InterruptSource=2, Period=32768, ReloadInput=0, ReloadInputMasked=0, Resolution=16, RunMode=0, StartInput=0, StartInputMasked=0, StopInput=1, StopInputMasked=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_Counter_PDL_v1_0, CY_CONFIG_TITLE=Timer_Echo, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_Echo, CY_INSTANCE_SHORT_NAME=Timer_Echo, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=tcpwm, CY_PDL_DRIVER_REQ_VERSION=1.0.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Timer_Echo, )
...
module top ;
    ...
    TCPWM_PWM_PDL_v1_0_2 PWM_Green (
        .clock(Net_39),
        .compare(Net_33),
        .count(1'b1),
        .interrupt(Net_35),
	...
	cy_mxs40_gpio_v1_0
		#(.id("c6fecd25-8c61-4ef3-b8b4-b951cc0bf461"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
	...
	cy_clock_v1_0
		#(.id("129bd537-bb61-42f4-8a40-412d63b5f624"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(0),
		  .period("83333333.3333333"),
		  .is_direct(0),
    ...
    TCPWM_Counter_PDL_v1_0_6 Timer_Echo (
        .capture(Net_59),
        .clock(Net_66),
        .compare(Net_54),
        .count(1'b1),
	...
	wire [0:0] tmpFB_0__Pin_US_Trigger_net;
	wire [0:0] tmpIO_0__Pin_US_Trigger_net;
	electrical [0:0] tmpSIOVREF__Pin_US_Trigger_net;

	cy_mxs40_gpio_v1_0
		#(.id("d7cf6105-0eb3-4606-bb99-6e6ac4fd8eb1"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		Pin_US_Trigger
		 (.oe({1'b1}),
		  .y({Net_84}),
		  .fb({tmpFB_0__Pin_US_Trigger_net[0:0]}),
		  .io({tmpIO_0__Pin_US_Trigger_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_US_Trigger_net));


    TCPWM_PWM_PDL_v1_0_7 PWM_Trigger (
        .clock(Net_77),
        .compare(Net_61),
        .count(1'b1),
        .interrupt(Net_63),
	...
	cy_clock_v1_0
		#(.id("658f1ef9-1761-4c70-bc1e-e9aa95dd1ff6"),
		  .source_clock_id("2FB4EC85-8328-4C5A-9ED9-8B63060178EB"),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
