...
#define CY_BLE_PROXIMITY_SERVICE_HANDLE   (0x0023u) /* Handle of Proximity service */
#define CY_BLE_PROXIMITY_DISTANCE_DECL_HANDLE   (0x0024u) /* Handle of Distance characteristic declaration */
#define CY_BLE_PROXIMITY_DISTANCE_CHAR_HANDLE   (0x0025u) /* Handle of Distance characteristic */
