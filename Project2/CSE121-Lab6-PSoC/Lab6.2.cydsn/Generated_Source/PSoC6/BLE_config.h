...
#define CY_BLE_CONFIG_GAP_PERIPHERAL_COUNT          (0x00u)
 ...
 */ 
#define CY_BLE_CONFIG_GAP_ROLE                      (0x02u)
...
#define CY_BLE_CONFIG_MAX_BONDED_DEVICES            (1u)
...
#define CY_BLE_CONFIG_GATT_DB_ATT_VAL_COUNT         (0x12u)
 ...
 */
#define CY_BLE_PROXIMITY_SERVICE_INDEX   (0x00u) /* Index of Proximity service in the cy_ble_customs array */
#define CY_BLE_PROXIMITY_DISTANCE_CHAR_INDEX   (0x00u) /* Index of Distance characteristic */


#define CY_BLE_PROXIMITY_SERVICE_HANDLE   (0x0021u) /* Handle of Proximity service */
#define CY_BLE_PROXIMITY_DISTANCE_DECL_HANDLE   (0x0022u) /* Handle of Distance characteristic declaration */
#define CY_BLE_PROXIMITY_DISTANCE_CHAR_HANDLE   (0x0023u) /* Handle of Distance characteristic */
