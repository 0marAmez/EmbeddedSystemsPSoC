...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x05u, 0x10u, 0x09u, 0x6Fu, 0x67u,
        0x61u, 0x6Du, 0x65u, 0x7Au, 0x71u, 0x75u, 0x20u,
        0x4Cu, 0x61u, 0x62u, 0x34u, 0x2Eu, 0x33u, 0x00u,
...
static uint8_t cy_ble_attValues[0x99u] = {
    /* Device Name */
    (uint8_t)'o', (uint8_t)'g', (uint8_t)'a', (uint8_t)'m', (uint8_t)'e', (uint8_t)'z', (uint8_t)'q', (uint8_t)'u',
(uint8_t)' ', (uint8_t)'L', (uint8_t)'a', (uint8_t)'b', (uint8_t)'4', (uint8_t)'.', (uint8_t)'3', 
...
(uint8_t)'C', (uint8_t)'S', (uint8_t)'E', (uint8_t)'1', (uint8_t)'2', (uint8_t)'1', (uint8_t)' ', (uint8_t)'L',
(uint8_t)'a', (uint8_t)'b', (uint8_t)'4', (uint8_t)'.', (uint8_t)'3', 
...
(uint8_t)'L', (uint8_t)'E', (uint8_t)' ', (uint8_t)'P', (uint8_t)'i', (uint8_t)'o', (uint8_t)'n', (uint8_t)'n',
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* Proximity */
    { 0x54u, 0x98u, 0xAAu, 0xAFu, 0x0Du, 0xAAu, 0xA2u, 0x8Fu, 0xA2u, 0x4Cu, 0x89u, 0x04u, 0xE0u, 0xC4u, 0x38u, 0x14u },
    /* Distance */
    { 0x18u, 0x31u, 0xC6u, 0xA0u, 0x36u, 0x36u, 0x2Eu, 0x83u, 0xFBu, 0x4Du, 0xE5u, 0x87u, 0xAFu, 0x99u, 0x25u, 0xD7u },
};
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x13u] = {
    ...
    { 0x001Du, (void *)&cy_ble_attValues[64] }, /* Model Number String */
    { 0x0000u, (void *)&cy_ble_attValues[93] }, /* Serial Number String */
    { 0x0026u, (void *)&cy_ble_attValues[93] }, /* Hardware Revision String */
    { 0x0005u, (void *)&cy_ble_attValues[131] }, /* Firmware Revision String */
    { 0x0000u, (void *)&cy_ble_attValues[136] }, /* Software Revision String */
    { 0x0008u, (void *)&cy_ble_attValues[136] }, /* System ID */
    { 0x0001u, (void *)&cy_ble_attValues[144] }, /* IEEE 11073-20601 Regulatory Certification Data List */
    { 0x0007u, (void *)&cy_ble_attValues[145] }, /* PnP ID */
    { 0x0010u, (void *)&cy_ble_attUuid128[0] }, /* Proximity UUID */
    { 0x0010u, (void *)&cy_ble_attUuid128[1] }, /* Distance UUID */
    { 0x0001u, (void *)&cy_ble_attValues[152] }, /* Distance */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x25u] = {
    ...
    { 0x0010u, 0x2800u /* Primary service                     */, 0x00000001u /*       */, 0x0022u, {{0x180Au, NULL}}                           },
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0012u, {{0x2A29u, NULL}}                           },
    { 0x0012u, 0x2A29u /* Manufacturer Name String            */, 0x01020001u /* rd    */, 0x0012u, {{0x0021u, (void *)&cy_ble_attValuesLen[7]}} },
    { 0x0013u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0014u, {{0x2A24u, NULL}}                           },
    { 0x0014u, 0x2A24u /* Model Number String                 */, 0x01020001u /* rd    */, 0x0014u, {{0x001Du, (void *)&cy_ble_attValuesLen[8]}} },
    { 0x0015u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0016u, {{0x2A25u, NULL}}                           },
    { 0x0016u, 0x2A25u /* Serial Number String                */, 0x01020001u /* rd    */, 0x0016u, {{0x0000u, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0017u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0018u, {{0x2A27u, NULL}}                           },
    { 0x0018u, 0x2A27u /* Hardware Revision String            */, 0x01020001u /* rd    */, 0x0018u, {{0x0026u, (void *)&cy_ble_attValuesLen[10]}} },
    { 0x0019u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x001Au, {{0x2A26u, NULL}}                           },
    { 0x001Au, 0x2A26u /* Firmware Revision String            */, 0x01020001u /* rd    */, 0x001Au, {{0x0005u, (void *)&cy_ble_attValuesLen[11]}} },
    { 0x001Bu, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x001Cu, {{0x2A28u, NULL}}                           },
    { 0x001Cu, 0x2A28u /* Software Revision String            */, 0x01020001u /* rd    */, 0x001Cu, {{0x0000u, (void *)&cy_ble_attValuesLen[12]}} },
    { 0x001Du, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x001Eu, {{0x2A23u, NULL}}                           },
    { 0x001Eu, 0x2A23u /* System ID                           */, 0x01020001u /* rd    */, 0x001Eu, {{0x0008u, (void *)&cy_ble_attValuesLen[13]}} },
    { 0x001Fu, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0020u, {{0x2A2Au, NULL}}                           },
    { 0x0020u, 0x2A2Au /* IEEE 11073-20601 Regulatory Certifi */, 0x01020001u /* rd    */, 0x0020u, {{0x0001u, (void *)&cy_ble_attValuesLen[14]}} },
    { 0x0021u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0022u, {{0x2A50u, NULL}}                           },
    { 0x0022u, 0x2A50u /* PnP ID                              */, 0x01020001u /* rd    */, 0x0022u, {{0x0007u, (void *)&cy_ble_attValuesLen[15]}} },
    { 0x0023u, 0x2800u /* Primary service                     */, 0x08000001u /*       */, 0x0025u, {{0x0010u, (void *)&cy_ble_attValuesLen[16]}} },
    { 0x0024u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0025u, {{0x0010u, (void *)&cy_ble_attValuesLen[17]}} },
    { 0x0025u, 0x99AFu /* Distance                            */, 0x09020001u /* rd    */, 0x0025u, {{0x0001u, (void *)&cy_ble_attValuesLen[18]}} },
};
