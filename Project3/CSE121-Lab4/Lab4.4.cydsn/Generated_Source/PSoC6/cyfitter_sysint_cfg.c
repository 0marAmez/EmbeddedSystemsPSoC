...
/* ARM CM0+ */
    ...
    const cy_stc_sysint_t SysInt_switch_cfg = {
        .intrSrc = (IRQn_Type)SysInt_switch__INTC_CORTEXM0P_MUX,
        .cm0pSrc = (cy_en_intr_t)SysInt_switch__INTC_NUMBER,
        .intrPriority = SysInt_switch__INTC_CORTEXM0P_PRIORITY
    };
...
/* ARM CM4 */
    ...
    /* Timer_Echo_Int */
    const cy_stc_sysint_t Timer_Echo_Int_cfg = {
        .intrSrc = (IRQn_Type)Timer_Echo_Int__INTC_NUMBER,
        .intrPriority = Timer_Echo_Int__INTC_CORTEXM4_PRIORITY
    };
