...
/* PWM_Blue */
#define PWM_Blue_TCPWM__CNT_HW TCPWM0_CNT5
#define PWM_Blue_TCPWM__CNT_IDX 5u
#define PWM_Blue_TCPWM__HW TCPWM0
#define PWM_Blue_TCPWM__IDX 0u
